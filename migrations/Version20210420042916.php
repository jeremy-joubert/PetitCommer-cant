 ...
 */
final class Version20210420042916 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE image ADD CONSTRAINT FK_C53D045FAB677BE6 FOREIGN KEY (boutique_id) REFERENCES boutique (id)');
    }
